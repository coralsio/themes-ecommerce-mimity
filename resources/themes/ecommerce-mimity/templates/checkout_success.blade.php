        ...
        <div class="card text-center">
            <div class="card-body padding-top-2x">
                ...
                <div class="padding-top-1x padding-bottom-1x">
                    ...
                    @else
                        <h5 class="text text-info">@lang('corals-ecommerce-mimity::labels.template.checkout_success.order_guest_email_sent',['email'=>isset($order) && $order->billing ?$order->billing['billing_address']['email']:''])</h5>
