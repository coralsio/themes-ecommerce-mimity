$(function () {
    ...
    // MORE & LESS toggle
    $('#main-sidebar .toggle').on("click", function() {
        var toggler = $(this);
    ...
    $('.btn-search-back').on("click", function (event) {
    ...
    $('.img-detail-list a').on("click", function (event) {
        event.preventDefault();
    });
    ...
    $('#img-detail').on("click", function (event) {
